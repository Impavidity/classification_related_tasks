...
if args.dataset == 'SST-1':
    TEXT = data.Field(batch_first=False, tokenize=clean_str_sst)
    ...
    for batch_idx, batch in enumerate(train_iter):
        ...
        if iterations % args.dev_every == 1:
            ...
            if dev_acc > best_dev_acc:
                ...
                snapshot_path = os.path.join(args.save_path, args.dataset, args.prefix+'_best_model.pt')
